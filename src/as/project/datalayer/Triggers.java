    ...
    public boolean onSave(Object entity, Serializable id, Object[] state, String[] propertyNames, Type[] types)
        ...
        if(entity instanceof Reserva){
            ...
            if (entity instanceof ReservaAmbNotificacio) {
                ...
                if(FactoriaDades.getInstance().getCurrentSession().get(Usuari.class, (Serializable) reserva.getUsuariCreador()) == null)
                ...
                List<Reserva> reservaList = (List<Reserva>)
                        FactoriaDades.getInstance().getCurrentSession().createCriteria(Reserva.class)
                                .add(Restrictions.eq("recurs_id", reserva.getRecurs().getNom()))
                                .add(Restrictions.eq("data", reserva.getData())).list();
